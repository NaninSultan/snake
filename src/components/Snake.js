...
const Snake = ({snake, setSnake}) => {
    ...
    return (
        <div>
            <div style={{marginTop: "120px", textAlign: "center", marginBottom: "40px"}} className="snake">
                {gameOver &&
                    <Typography variant="h4" style={{color: "red", fontWeight: "1000"}}>GAME OVER</Typography>
                }
                <br/>
